...
###############################
    ...
    ##THIS IS A DUMMY FILE, WE DON'T USE FINAL DATES ANYMORE, WE JUST INCLUDE
    ##FOR THE FILE DEPENDENCY
...
def spring_2024_finals_logic(abbreviation, course_number, start_time, is_foreign_language, day_string):
...
finals_mapper = FinalTimesMapper(spring_2024_finals_logic)