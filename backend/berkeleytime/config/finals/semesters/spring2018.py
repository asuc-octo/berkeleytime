...
MWF_FINALS = {
    ...
    datetime.time(11, 0): FINAL_TIMES["Friday11:30-2:30PM"],
...
def spring_2018_finals_logic(abbreviation, course_number, start_time, is_foreign_language, day_string):
    if abbreviation == 'CHEM' and course_number in ["1A", "1B"]:
        return FINAL_TIMES.get("Wednesday8-11AM")
        ...
        if is_weekend_class(day_string):
            return FINAL_TIMES.get("Thursday7-10PM")
    return None

finals_mapper = FinalTimesMapper(spring_2018_finals_logic)