...
export namespace CatalogModule {
  ...
  export type EnrollmentDay = Pick<
    Types.EnrollmentDay,
    DefinedFields["EnrollmentDay"]
  >;
  ...
  export type QueryResolvers = Pick<
    ...
    DefinedFields["Query"]
  >;
  export type CourseResolvers = Pick<
    Types.CourseResolvers,
    DefinedFields["Course"] | "__isTypeOf"
  >;
  export type ClassResolvers = Pick<
    Types.ClassResolvers,
    DefinedFields["Class"] | "__isTypeOf"
  >;
  export type SectionResolvers = Pick<
    Types.SectionResolvers,
    DefinedFields["Section"] | "__isTypeOf"
  >;
  export type ReservationResolvers = Pick<
    Types.ReservationResolvers,
    DefinedFields["Reservation"] | "__isTypeOf"
  >;
  export type MeetingResolvers = Pick<
    Types.MeetingResolvers,
    DefinedFields["Meeting"] | "__isTypeOf"
  >;
  export type ExamResolvers = Pick<
    Types.ExamResolvers,
    DefinedFields["Exam"] | "__isTypeOf"
  >;
  export type InstructorResolvers = Pick<
    Types.InstructorResolvers,
    DefinedFields["Instructor"] | "__isTypeOf"
  >;
  export type EnrollmentDayResolvers = Pick<
    Types.EnrollmentDayResolvers,
    DefinedFields["EnrollmentDay"] | "__isTypeOf"
  >;
  export type CourseListItemResolvers = Pick<
    Types.CourseListItemResolvers,
    DefinedFields["CourseListItem"] | "__isTypeOf"
  >;
