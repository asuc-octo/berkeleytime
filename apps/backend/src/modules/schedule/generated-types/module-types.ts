...
export namespace ScheduleModule {
  ...
  export type CustomEventInput = Pick<
    Types.CustomEventInput,
    DefinedInputFields["CustomEventInput"]
  >;
  export type SelectedCourseInput = Pick<
    Types.SelectedCourseInput,
    DefinedInputFields["SelectedCourseInput"]
  >;
  export type ScheduleInput = Pick<
    Types.ScheduleInput,
    DefinedInputFields["ScheduleInput"]
  >;
  ...
  export type SelectedCourse = Pick<
    Types.SelectedCourse,
    DefinedFields["SelectedCourse"]
  >;
  export type CustomEvent = Pick<
    Types.CustomEvent,
    DefinedFields["CustomEvent"]
  >;
  export type Query = Pick<Types.Query, DefinedFields["Query"]>;
  export type Mutation = Pick<Types.Mutation, DefinedFields["Mutation"]>;

  export type TermOutputResolvers = Pick<
    Types.TermOutputResolvers,
    DefinedFields["TermOutput"] | "__isTypeOf"
  >;
  export type ScheduleResolvers = Pick<
    Types.ScheduleResolvers,
    DefinedFields["Schedule"] | "__isTypeOf"
  >;
  export type SelectedCourseResolvers = Pick<
    Types.SelectedCourseResolvers,
    DefinedFields["SelectedCourse"] | "__isTypeOf"
  >;
  export type CustomEventResolvers = Pick<
    Types.CustomEventResolvers,
    DefinedFields["CustomEvent"] | "__isTypeOf"
  >;
