...
export default function CarouselClass({ onSelect, year, semester, subject, courseNumber, number }: CarouselClassProps) {
    ...
    loading || !_class ? <></> :
      ...
      >
        <div className={styles.text}>
          ...
          <p className={styles.description}>{_class.title ?? _class.course.title}</p>
