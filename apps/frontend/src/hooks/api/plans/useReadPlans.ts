...
import { GetPlansDocument, GetPlansQuery, GetPlansQueryVariables } from "@/lib/generated/graphql";

export const useReadPlans = (
  options?: Omit<useQuery.Options<GetPlansQuery, GetPlansQueryVariables>, "variables">
) => {
