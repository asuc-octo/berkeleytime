...
import { GetPlanDocument, GetPlanQuery, GetPlanQueryVariables } from "@/lib/generated/graphql";

export const useReadPlan = (
  options?: Omit<useQuery.Options<GetPlanQuery, GetPlanQueryVariables>, "variables">
) => {
