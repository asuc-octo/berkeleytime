  ...
  return (
    ...
    <Container style={{marginBottom: "80px"}}>
      <div className={styles.header}>
        <div className={styles.title}>Welcome to Berkeleytime&apos;s Scheduler</div>
        ...
        <CreateScheduleDialog defaultName={`Schedule ${schedules.length + 1}`}>
          <Button 
            variant="solid"
          >
            Create Schedule
      ...
      <div className={styles.schedulesCont}>
        ...
        {Object.keys(schedulesBySemester).sort((a, b) => {
          return (schedulesBySemester[a][0].year == schedulesBySemester[b][0].year) ? SEMESTER_ORDER.indexOf(schedulesBySemester[b][0].semester) - SEMESTER_ORDER.indexOf(schedulesBySemester[a][0].semester) : schedulesBySemester[b][0].year - schedulesBySemester[a][0].year
        }).map((sem) => {
          return <Carousel.Root key={sem} title={sem} Icon={<Calendar/>}>
