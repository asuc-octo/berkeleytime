"""Mondaine resources for reading/composition."""
...
class ReadingResource(object):
    ...
    url = 'http://guide.berkeley.edu/undergraduate/colleges-schools/letters-science/reading-composition-requirement/'  # noqa
    ...
    def map_def_classes(self, rc_table, either_table):
        """Given a table for R1A or R1B classes and a table of either classes, returns a MapperDefinition with the classes added.""" # noqa
