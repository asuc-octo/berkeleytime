...
# CHANGE THESE DICTIONARIES SEMESTER TO SEMESTER
MWF_FINALS = {
...
def fall_2016_finals_logic(abbreviation, course_number, start_time, is_foreign_language, day_string):
...
finals_mapper = FinalTimesMapper(fall_2016_finals_logic)