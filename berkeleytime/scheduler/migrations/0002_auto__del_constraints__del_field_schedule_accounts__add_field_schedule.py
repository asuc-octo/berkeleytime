...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Schedule.accounts'
        db.delete_column(u'scheduler_schedule', 'accounts_id')

        # Adding field 'Schedule.user_profile'
        db.add_column(u'scheduler_schedule', 'user_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=37, to=orm['account.BerkeleytimeUserProfile']),
                      keep_default=False)

        # Adding field 'Schedule.is_invalid'
        db.add_column(u'scheduler_schedule', 'is_invalid',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Schedule.accounts'
        db.add_column(u'scheduler_schedule', 'accounts',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=37, to=orm['account.BerkeleytimeUserProfile']),
                      keep_default=False)
        ...
        # Deleting field 'Schedule.is_invalid'
        db.delete_column(u'scheduler_schedule', 'is_invalid')
    ...
    models = {
        ...
        u'scheduler.schedule': {
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.BerkeleytimeUserProfile']"})
        }
    }
