...
class Migration(SchemaMigration):
    # latest_enrolled_percentage = models.FloatField(default=-1)
    # latest_open_seats = models.IntegerField(default=-1)
    # latest_enrolled = models.IntegerField(default=-1)
    # latest_enrolled_max =  models.IntegerField(default=-1)
    # latest_waitlisted = models.IntegerField(default=-1)

    def forwards(self, orm):
        db.rename_column('catalog_course', 'latest_enrolled_percentage', 'enrolled_percentage')
        db.rename_column('catalog_course', 'latest_open_seats', 'open_seats')
        db.rename_column('catalog_course', 'latest_enrolled', 'enrolled')
        db.rename_column('catalog_course', 'latest_enrolled_max', 'enrolled_max')
        db.rename_column('catalog_course', 'latest_waitlisted', 'waitlisted')

    def backwards(self, orm):
        db.rename_column('catalog_course', 'enrolled_percentage', 'latest_enrolled_percentage')
        db.rename_column('catalog_course', 'open_seats', 'latest_open_seats')
        db.rename_column('catalog_course', 'enrolled', 'latest_enrolled')
        db.rename_column('catalog_course', 'enrolled_max', 'latest_enrolled_max')
        db.rename_column('catalog_course', 'waitlisted', 'latest_waitlisted')
