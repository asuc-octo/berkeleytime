...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalog_course', 'prerequisites', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 12, 28, 0, 0)'}),
