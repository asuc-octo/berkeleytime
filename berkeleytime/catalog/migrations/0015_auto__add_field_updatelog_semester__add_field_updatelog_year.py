...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UpdateLog.semester'
        db.add_column('catalog_updatelog', 'semester',
                      self.gf('django.db.models.fields.CharField')(default='fall', max_length=50),
                      keep_default=False)

        # Adding field 'UpdateLog.year'
        db.add_column('catalog_updatelog', 'year',
                      self.gf('django.db.models.fields.CharField')(default='2013', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UpdateLog.semester'
        db.delete_column('catalog_updatelog', 'semester')

        # Deleting field 'UpdateLog.year'
        db.delete_column('catalog_updatelog', 'year')
    ...
    models = {
        ...
        'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'}),
        ...
        'catalog.updatelog': {
            ...
            'year': ('django.db.models.fields.CharField', [], {'default': "'2013'", 'max_length': '4'})
        },
