...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.user_email'
        db.add_column(u'catalog_playlist', 'user_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.user_email'
        db.delete_column(u'catalog_playlist', 'user_email')
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 3, 4, 0, 0)'}),
        ...
        u'catalog.updatelog': {
            ...
            'year': ('django.db.models.fields.CharField', [], {'default': "'2018'", 'max_length': '4'})
        },
