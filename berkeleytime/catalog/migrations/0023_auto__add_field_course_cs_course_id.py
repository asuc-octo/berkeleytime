...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.cs_course_id'
        db.add_column(u'catalog_course', 'cs_course_id',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.cs_course_id'
        db.delete_column(u'catalog_course', 'cs_course_id')
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 17, 0, 0)'}),
