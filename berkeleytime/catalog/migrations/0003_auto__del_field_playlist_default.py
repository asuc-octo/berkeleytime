...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Playlist.default'
        db.delete_column('catalog_playlist', 'default')


    def backwards(self, orm):
        # Adding field 'Playlist.default'
        db.add_column('catalog_playlist', 'default',
    ...
    models = {
        ...
        'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 15, 0, 0)'}),
