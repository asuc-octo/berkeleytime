...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        # Yuxin (circular depency issue for from-scratch migrations) Modifies standard_location 0001, but removed in 0008
        # Changing field 'Section.standard_location'
        # db.alter_column('catalog_section', 'standard_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campus.Classroom'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        pass

        # Changing field 'Section.standard_location'
        # db.alter_column('catalog_section', 'standard_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campus.Classroom'], null=True))
    ...
    models = {
        ...
        'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 27, 0, 0)'}),
        ...
        'catalog.section': {
            ...
            'standard_location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['campus.Classroom']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
