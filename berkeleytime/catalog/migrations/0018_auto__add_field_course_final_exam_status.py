...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.final_exam_status'
        db.add_column(u'catalog_course', 'final_exam_status',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.final_exam_status'
        db.delete_column(u'catalog_course', 'final_exam_status')
