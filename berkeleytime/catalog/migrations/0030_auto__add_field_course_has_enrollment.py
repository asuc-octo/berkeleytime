...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.has_enrollment'
        db.add_column(u'catalog_course', 'has_enrollment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.has_enrollment'
        db.delete_column(u'catalog_course', 'has_enrollment')
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 16, 0, 0)'}),
