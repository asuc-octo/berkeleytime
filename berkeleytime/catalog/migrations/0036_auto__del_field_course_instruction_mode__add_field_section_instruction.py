...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.instruction_mode'
        db.delete_column(u'catalog_course', 'instruction_mode')

        # Adding field 'Section.instruction_mode'
        db.add_column(u'catalog_section', 'instruction_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.instruction_mode'
        db.add_column(u'catalog_course', 'instruction_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Section.instruction_mode'
        db.delete_column(u'catalog_section', 'instruction_mode')
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 7, 5, 0, 0)'}),
        ...
        u'catalog.playlist': {
            ...
            'year': ('django.db.models.fields.CharField', [], {'default': "'2020'", 'max_length': '4'})
        },
        u'catalog.section': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instruction_mode': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
