...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalog_course', 'previously', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Course.credit_option'
        db.alter_column('catalog_course', 'credit_option', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Course.abbreviation'
        db.alter_column('catalog_course', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.grading_option'
        db.alter_column('catalog_course', 'grading_option', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Course.title'
        db.alter_column('catalog_course', 'title', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Course.course_number'
        db.alter_column('catalog_course', 'course_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Course.units'
        db.alter_column('catalog_course', 'units', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Course.letter_average'
        db.alter_column('catalog_course', 'letter_average', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Course.primary_kind'
        db.alter_column('catalog_course', 'primary_kind', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.format'
        db.alter_column('catalog_course', 'format', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

        # Changing field 'Course.time'
        db.alter_column('catalog_course', 'time', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Course.department'
        db.alter_column('catalog_course', 'department', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Course.standard_department'
        db.alter_column('catalog_course', 'standard_department', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Course.level'
        db.alter_column('catalog_course', 'level', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Course.prerequisites'
        db.alter_column('catalog_course', 'prerequisites', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Section.suffix'
        db.alter_column('catalog_section', 'suffix', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Section.section_number'
        db.alter_column('catalog_section', 'section_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.abbreviation'
        db.alter_column('catalog_section', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.semester'
        db.alter_column('catalog_section', 'semester', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.year'
        db.alter_column('catalog_section', 'year', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'Section.course_number'
        db.alter_column('catalog_section', 'course_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.location'
        db.alter_column('catalog_section', 'location', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Section.units'
        db.alter_column('catalog_section', 'units', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Section.course_title'
        db.alter_column('catalog_section', 'course_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Section.instructor'
        db.alter_column('catalog_section', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Section.kind'
        db.alter_column('catalog_section', 'kind', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Section.days'
        db.alter_column('catalog_section', 'days', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.ccn'
        db.alter_column('catalog_section', 'ccn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Tip.instructor'
        db.alter_column('catalog_tip', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Course.previously'
        db.alter_column('catalog_course', 'previously', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Course.credit_option'
        db.alter_column('catalog_course', 'credit_option', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'Course.abbreviation'
        db.alter_column('catalog_course', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Course.grading_option'
        db.alter_column('catalog_course', 'grading_option', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'Course.title'
        db.alter_column('catalog_course', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Course.course_number'
        db.alter_column('catalog_course', 'course_number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Course.units'
        db.alter_column('catalog_course', 'units', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Course.letter_average'
        db.alter_column('catalog_course', 'letter_average', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Course.primary_kind'
        db.alter_column('catalog_course', 'primary_kind', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Course.format'
        db.alter_column('catalog_course', 'format', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'Course.time'
        db.alter_column('catalog_course', 'time', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Course.department'
        db.alter_column('catalog_course', 'department', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Course.standard_department'
        db.alter_column('catalog_course', 'standard_department', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Course.level'
        db.alter_column('catalog_course', 'level', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Course.prerequisites'
        db.alter_column('catalog_course', 'prerequisites', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'Section.suffix'
        db.alter_column('catalog_section', 'suffix', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Section.section_number'
        db.alter_column('catalog_section', 'section_number', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Section.abbreviation'
        db.alter_column('catalog_section', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Section.semester'
        db.alter_column('catalog_section', 'semester', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Section.year'
        db.alter_column('catalog_section', 'year', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Section.course_number'
        db.alter_column('catalog_section', 'course_number', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Section.location'
        db.alter_column('catalog_section', 'location', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Section.units'
        db.alter_column('catalog_section', 'units', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Section.course_title'
        db.alter_column('catalog_section', 'course_title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Section.instructor'
        db.alter_column('catalog_section', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Section.kind'
        db.alter_column('catalog_section', 'kind', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Section.days'
        db.alter_column('catalog_section', 'days', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Section.ccn'
        db.alter_column('catalog_section', 'ccn', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Tip.instructor'
        db.alter_column('catalog_tip', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    models = {
        ...
        'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 28, 0, 0)'}),
