...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'catalog_enrollment', 'year')

        # Deleting field 'Enrollment.semester'
        db.delete_column(u'catalog_enrollment', 'semester')

        # Deleting field 'Enrollment.ccn'
        db.delete_column(u'catalog_enrollment', 'ccn')

        # Deleting field 'Enrollment.live'
        db.delete_column(u'catalog_enrollment', 'live')

        # Deleting field 'Enrollment.no_waitlist'
        db.delete_column(u'catalog_enrollment', 'no_waitlist')

        # Deleting field 'Enrollment.manual_waitlist'
        db.delete_column(u'catalog_enrollment', 'manual_waitlist')


    def backwards(self, orm):
        # Adding field 'Enrollment.year'
        db.add_column(u'catalog_enrollment', 'year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4),
                      keep_default=False)

        # Adding field 'Enrollment.semester'
        db.add_column(u'catalog_enrollment', 'semester',
                      self.gf('django.db.models.fields.CharField')(default='fall', max_length=20),
                      keep_default=False)

        # Adding field 'Enrollment.ccn'
        db.add_column(u'catalog_enrollment', 'ccn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Enrollment.live'
        db.add_column(u'catalog_enrollment', 'live',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Enrollment.no_waitlist'
        db.add_column(u'catalog_enrollment', 'no_waitlist',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Enrollment.manual_waitlist'
        db.add_column(u'catalog_enrollment', 'manual_waitlist',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 2, 0, 0)'}),
        ...
        u'catalog.updatelog': {
            ...
            'semester': ('django.db.models.fields.CharField', [], {'default': "'fall'", 'max_length': '50'}),
