...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.favorite_count'
        db.add_column('catalog_course', 'favorite_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.favorite_count'
        db.delete_column('catalog_course', 'favorite_count')
    ...
    models = {
        ...
        'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 22, 0, 0)'}),
