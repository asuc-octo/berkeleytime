...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.previously'
        db.alter_column(u'catalog_course', 'previously', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Course.title'
        db.alter_column(u'catalog_course', 'title', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Course.final_exam_status'
        db.alter_column(u'catalog_course', 'final_exam_status', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Course.hours'
        db.alter_column(u'catalog_course', 'hours', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

        # Changing field 'Course.prerequisites'
        db.alter_column(u'catalog_course', 'prerequisites', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Course.grading'
        db.alter_column(u'catalog_course', 'grading', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Course.credit_restrictions'
        db.alter_column(u'catalog_course', 'credit_restrictions', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
    ...
    models = {
        ...
        u'catalog.course': {
            ...
            'credit_restrictions': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            ...
            'final_exam_status': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'grade_average': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'grading': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'hours': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'prerequisites': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'previously': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
