...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'Section.location' to 'Section.location_name'
        db.rename_column('catalog_section', 'location', 'location_name')

    def backwards(self, orm):
        # Rename 'Section.location_name' to 'Section.location'
        db.rename_column('catalog_section', 'location_name', 'location')
