...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Enrollment', fields ['date_created', 'section']
        db.create_unique(u'catalog_enrollment', ['date_created', 'section_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Enrollment', fields ['date_created', 'section']
        db.delete_unique(u'catalog_enrollment', ['date_created', 'section_id'])
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 3, 0, 0)'}),
