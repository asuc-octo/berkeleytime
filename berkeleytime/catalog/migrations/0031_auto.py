...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field textbooks on 'Section'
        db.create_table(u'catalog_section_textbooks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('section', models.ForeignKey(orm[u'catalog.section'], null=False)),
            ('textbook', models.ForeignKey(orm[u'marketplace.textbook'], null=False))
        ))
        db.create_unique(u'catalog_section_textbooks', ['section_id', 'textbook_id'])


    def backwards(self, orm):
        # Removing M2M table for field textbooks on 'Section'
        db.delete_table('catalog_section_textbooks')
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 8, 6, 0, 0)'}),
