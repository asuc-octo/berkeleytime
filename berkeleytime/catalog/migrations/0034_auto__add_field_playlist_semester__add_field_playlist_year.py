...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.semester'
        db.add_column(u'catalog_playlist', 'semester',
                      self.gf('django.db.models.fields.CharField')(default='spring', max_length=50),
                      keep_default=False)

        # Adding field 'Playlist.year'
        db.add_column(u'catalog_playlist', 'year',
                      self.gf('django.db.models.fields.CharField')(default='2020', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.semester'
        db.delete_column(u'catalog_playlist', 'semester')

        # Deleting field 'Playlist.year'
        db.delete_column(u'catalog_playlist', 'year')
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 3, 7, 0, 0)'}),
