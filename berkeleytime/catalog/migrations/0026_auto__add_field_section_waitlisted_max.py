...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.waitlisted_max'
        db.add_column(u'catalog_section', 'waitlisted_max',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.waitlisted_max'
        db.delete_column(u'catalog_section', 'waitlisted_max')
