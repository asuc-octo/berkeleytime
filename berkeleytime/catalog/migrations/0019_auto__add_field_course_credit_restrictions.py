...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.credit_restrictions'
        db.add_column(u'catalog_course', 'credit_restrictions',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.credit_restrictions'
        db.delete_column(u'catalog_course', 'credit_restrictions')
    ...
    models = {
        ...
        u'catalog.course': {
            ...
            'credit_restrictions': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            ...
            'final_exam_status': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
