...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Course', fields ['abbreviation', 'course_number']
        db.create_unique(u'catalog_course', ['abbreviation', 'course_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Course', fields ['abbreviation', 'course_number']
        db.delete_unique(u'catalog_course', ['abbreviation', 'course_number'])
    ...
    models = {
        ...
        u'catalog.enrollment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 2, 0, 0)'}),
