...
class Migration(SchemaMigration):
    ...
    depends_on = [
        ('campus', '0003_auto__add_building__add_room'),
    ]

    def forwards(self, orm):
        # Adding field 'Section.standard_location'
        db.add_column('catalog_section', 'standard_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campus.Room'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.standard_location'
        db.delete_column('catalog_section', 'standard_location_id')
