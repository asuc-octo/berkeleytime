...
export type CourseFragment = { __typename?: "CourseType" } & Pick<
  CourseType,
  | "title"
  | "units"
  | "waitlisted"
  ...
  | "prerequisites"
> & {
    playlistSet: { __typename?: "PlaylistTypeConnection" } & {
      edges: Array<
        Maybe<
          { __typename?: "PlaylistTypeEdge" } & {
            node?: Maybe<
              { __typename?: "PlaylistType" } & Pick<
                PlaylistType,
                "category" | "id" | "name" | "semester" | "year"
              >
            >;
          }
        >
    ...
    sectionSet: { __typename?: "SectionTypeConnection" } & {
      edges: Array<
        Maybe<
          { __typename?: "SectionTypeEdge" } & {
            node?: Maybe<{ __typename?: "SectionType" } & SectionFragment>;
          }
        >
      >;
    };
...
export type CourseOverviewFragment = { __typename?: "CourseType" } & Pick<
  CourseType,
  | "id"
  | "abbreviation"
  | "courseNumber"
...
export type FilterFragment = { __typename?: "PlaylistType" } & Pick<
  PlaylistType,
  "id" | "name" | "category"
>;

export type SectionFragment = { __typename?: "SectionType" } & Pick<
  SectionType,
  | "id"
  | "ccn"
  | "kind"
...
> & {
    ...
    >;
    savedClasses?: Maybe<
      Array<Maybe<{ __typename?: "CourseType" } & CourseOverviewFragment>>
    >;
  };
...
export type LoginMutation = { __typename?: "Mutation" } & {
  login?: Maybe<
    { __typename?: "ObtainJSONWebToken" } & Pick<
      ObtainJsonWebToken,
      "newUser" | "refreshExpiresIn" | "payload"
    > & {
        user?: Maybe<
          { __typename?: "BerkeleytimeUserType" } & UserProfileFragment
        >;
      }
  >;
};
...
export type GetCourseForIdQuery = { __typename?: "Query" } & {
  course?: Maybe<{ __typename?: "CourseType" } & CourseFragment>;
};
...
export type GetCoursesForFilterQuery = { __typename?: "Query" } & {
  allCourses?: Maybe<
    { __typename?: "CourseTypeConnection" } & {
      edges: Array<
        Maybe<
          { __typename?: "CourseTypeEdge" } & {
            node?: Maybe<
              { __typename?: "CourseType" } & CourseOverviewFragment
            >;
          }
        >
      >;
  ...
  allPlaylists?: Maybe<
    { __typename?: "PlaylistTypeConnection" } & {
      edges: Array<
        Maybe<
          { __typename?: "PlaylistTypeEdge" } & {
            node?: Maybe<{ __typename?: "PlaylistType" } & FilterFragment>;
          }
        >
      >;
    }
...
export type GetSemestersQuery = { __typename?: "Query" } & {
  allPlaylists?: Maybe<
    { __typename?: "PlaylistTypeConnection" } & {
      edges: Array<
        Maybe<
...
export type GetUserQuery = { __typename?: "Query" } & {
  user?: Maybe<{ __typename?: "BerkeleytimeUserType" } & UserProfileFragment>;
};
...
export function useGetCoursesForFilterQuery(
  ...
  return Apollo.useQuery<
    GetCoursesForFilterQuery,
    GetCoursesForFilterQueryVariables
  >(GetCoursesForFilterDocument, baseOptions);
}
...
export function useStubQuery(
  ...
  return Apollo.useQuery<StubQuery, StubQueryVariables>(
    StubDocument,
    baseOptions
  );
}
