...
const questions = [
	{
		...
		answer: (
			<P>
				...
				<a href="https://calanswers.berkeley.edu/">CalAnswers</a>. Let us know if anything seems
				off!
			</P>
		)
	},
	{
		...
		answer: (
			<P>
				This is not a bug; the percent enrolled graph compares the number of students enrolled at a
				given time to the current enrollment cap of the class. Throughout the semester, professors
				or department admins may choose to decrease the class size below the number of students
				enrolled to limit further enrollment. Hence, some classes may show over 100% enrollment at
				certain points in the enrollment timeline.{' '}
			</P>
		)
	},
	{
	...
	},
	{
		...
		answer: (
			<P>
				All of our data is made available to our users as soon as it is published by the school. For
				class information, this typically occurs 2 weeks before the start of Phase I. Grades data is
				typically published 2-3 months after the end of the semester. Enrollment data is refreshed
				continuously as students enroll and drop classes throughout the semester.
			</P>
		)
	},
	{
		...
		answer: (
			<P>
				...
				<a href="https://octo.asuc.org//">ASUC Office of the CTO</a>. Our team meets weekly to
				maintain and improve the site. You can learn more about us <Link to="/about">here</Link>!
			</P>
		)
	},
	/*{
  ...
  },*/
	{
		...
		answer: (
			<P>
				...
				<a href="mailto: octo.berkeleytime@asuc.org">email us</a> and we can direct you to the data
				sources we use for our API.
			</P>
		)
	},
	/*{
  ...
  },*/
	{
		...
		answer: (
			<P>
				We appreciate the feature request! The BT team has discussed this at length, and,
				unfortunately, we are not able to offer any such review or rating system at the current
				time. This is because we work closely with the Berkeley Academic Senate. Also as a part of
				the ASUC, we cannot officially incorporate or endorse opinions we either don’t moderate or
				are not our own.
			</P>
		)
	}
