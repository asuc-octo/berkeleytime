    ...
    return (
      <div className="grades-info">
        ...
        <div className="course-average">
          <span className={courseLetter ? getGradeColor(courseLetter) : ""}>
            {courseLetter}
          </span>
        ...
        <div className="section-average">
          <span className={sectionLetter ? getGradeColor(sectionLetter) : ""}>
            {sectionLetter}
          </span>
        ...
        {selectedGrade !== undefined &&
          ...
          selectedPercentiles !== null && (
            <div>
              ...
              {Math.round(
                (selectedPercentiles.numerator / denominator) * 1000
              ) / 10}
              %)
            </div>
          )}
