...
class ClassCardList extends PureComponent {
  render() {
    const { selectedCourses, removeCourse, additionalInfo, type, isMobile } =
      this.props;
        ...
        <Row>
          {selectedCourses.map((item, i) => (
            <ClassCard
              ...
              semester={
                item.semester === "all" ? "All Semesters" : item.semester
              }
              faculty={
                item.instructor === "all" ? "All Instructors" : item.instructor
              }
