  ...
  <div className="landing-explore">
    ...
    <Row>
      <Col xs={12} md={4} className="feature">
        ...
        <p className='bt-p'>Search through 12,000+ courses at Berkeley. Apply filters for requirements.</p>
      </Col>
      <Col xs={12} md={4} className="feature">
        <img src={grade} className="mb-4" alt="grades" />
        <h6 className='bt-h6 bt-bold mb-3'>Grade Distributions</h6>
        <p className='bt-p'>View and compare grade distributions for each course and semester.</p>
      </Col>
      <Col xs={12} md={4} className="feature">
        <img src={history} className="mb-4" alt="history" />
        <h6 className='bt-h6 bt-bold mb-3'>Enrollment History</h6>
        <p className='bt-p'>Track accurate, real-time course enrollment trends and history.</p>
      </Col>
    </Row>
  </div>
)
