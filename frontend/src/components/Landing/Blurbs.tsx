...
const Blurbs: FC = () => (
  <>
    ...
    {/*    <P className="mb-3">Thank you to the folks that help the Stanfurdtime team continue to provide this service free-of-charge to students!</P>*/}
    {/*  </div>*/}
    {/*  <div className="sponsors">*/}
    {/*    <a href="https://www.hoover.org">*/}
