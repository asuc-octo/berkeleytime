import { ArrowRight, Discord, Facebook, GitHub, Instagram } from 'iconoir-react';
		...
		<div className={styles.root}>
			<div className={styles.info}>
				...
				<div className={styles.infoBlock}>
					<h2>Get Involved</h2>
					<p>
						Berkeleytime is maintained by students just like you! If you're looking to make a
						difference – we're looking for you.
					</p>
					<p>
						<a>
				...
				<div className={styles.infoBlock}>
					<h2>Have Feedback?</h2>
					<p>
						We'd love to hear it! User feedback helps us continually improve Berkeleytime. We want
