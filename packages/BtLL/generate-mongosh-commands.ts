...
const requirements: PlanRequirementSeed[] = [
  ...
  {
    name: "College of Letters & Science Requirements",
    code: LNS_REQ_BTLL,
    isUcReq: false,
    college: "LnS",
    major: null,
  ...
  {
    name: "Mechanical Engineering Major Requirements",
    code: MECHE_REQ_BTLL,
    isUcReq: false,
    college: null,
  ...
  {
    name: "Data Science Major Requirements",
  ...
  {
    name: "Economics Major Requirements",
    code: ECON_REQ_BTLL,
    isUcReq: false,
    college: null,
    major: "Economics",
  ...
  {
    name: "Business Administration Major Requirements",
    code: BUSINESS_REQ_BTLL,
    isUcReq: false,
    college: null,
